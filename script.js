...
function displayFoods1(foods) {
 foods.forEach(food => {
    ...
    FOODIMG.setAttribute("src" , `${food.image}`);
    const FOODIMG1 = document.createElement("img");
    FOODIMG1.setAttribute("src" , `${food.image}`);
    const FOODIMG2 = document.createElement("img");
    FOODIMG2.setAttribute("src" , `${food.image}`);
 ...
 exhabit.className = "exhabit";
  ...
  Burgertitle.textContent = `${food.category}`;
  ...
  BURGERSPOSITION.textContent = `${food.category}`;
